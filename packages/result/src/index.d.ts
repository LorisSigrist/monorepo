...
/**
 * Represents a result of an operation that can either be successful or failed. If successful, it
 * contains the value of the operation. If failed, it contains the error key and the value of the
 * operation.
 */
